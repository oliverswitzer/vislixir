defmodule Vislixir.Tracer do
  ...
  def handle_info({:trace, from_pid, :send, msg, to_pid}, visualizer_node) do
    ...
    :rpc.call(visualizer_node, TraceChannel, :announce_msg, [from_pid, to_pid, msg])
    {:noreply, visualizer_node}
  end

  def handle_info({:nodedown, visualizer_node}, visualizer_node) do
    :erlang.display('[Vislixir] Lost connection to visualizer node, purging Tracer module.')
