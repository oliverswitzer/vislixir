#
# Note, in order to use this module, you'll need to start Vislixir in fully-qualified name mode, with 127.0.0.1 as the hostname.
#
# ex: iex --name visualixir@127.0.0.1 -S mix phx.server
#
defmodule Vislixir.Support.Cluster do
  require Logger
